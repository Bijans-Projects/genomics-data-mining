...
itables.show(df_clinical_patients)
...
itables.show(df_clinical_samples)
...
timeline_sample_acquisition_file = Path("data/external/extracted/lgg_tcga_pan_can_atlas_2018/data_timeline_sample_acquisition.txt")
df_timeline_sample_acquisition = pd.read_csv(timeline_sample_acquisition_file, sep="\t", comment="#")


df_timeline_sample_acquisition.groupby("METHOD_OF_SAMPLE_PROCUREMENT")["TUMOR_WEIGHT"].mean()
...
### RNA Sequencing
Goal: From a tissue sample of a tumor, find out how many genes are being expressed
